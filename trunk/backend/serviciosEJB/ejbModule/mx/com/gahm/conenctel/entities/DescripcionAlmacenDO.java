...
/**
 * Clase de persistencia para la tabla descripcionalmacen.
 * 
 * @author Carlos Leyva
 */
@Entity
@NamedQueries({
	@NamedQuery(name = "DescripcionAlmacenDO.findAll", query = "select d from DescripcionAlmacenDO d") })
@Table(name="descripcionalmacen")
public class DescripcionAlmacenDO implements Serializable {

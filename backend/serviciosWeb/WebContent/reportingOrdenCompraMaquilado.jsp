...
<%
	...
	try {
		...
		IOrdenCompraMaquiladoService service = (IOrdenCompraMaquiladoService) context.lookup("ejb/OrdenCompraMaquiladoService");
		Integer idInteger = Integer.valueOf( id.toString() );
		OrdenCompraMaquiladoDO ordenCompra = service.getItem( idInteger );
		List<OrdenCompraMaquiladoDO> list = new ArrayList<OrdenCompraMaquiladoDO>();
		list.add( ordenCompra );
		System.out.println("\n\n\n----------------------------------------------");
		System.out.println("subtotal: " + ordenCompra.getSubtotal());
		System.out.println("iva: " + ordenCompra.getIva());

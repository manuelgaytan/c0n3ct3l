...
@Entity
@Table(name="EquipoMedicionSolicitudAlmacen")
@NamedQueries({
	@NamedQuery(name = "EquipoMedicionSolicitudAlmacenDO.findAll", query = "select ha from EquipoMedicionSolicitudAlmacenDO ha where ha.solicitudAlmacen.id=:id")})
public class EquipoMedicionSolicitudAlmacenDO implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="fk_equipo_medicion")
	private EquipoMedicionDO equipoMedicion;
	...
	public EquipoMedicionDO getEquipoMedicion() {
		return equipoMedicion;
	}

	public void setEquipoMedicion(EquipoMedicionDO equipoMedicion) {

...
@NamedQueries({
	...
	@NamedQuery(name = "FacturaPorPagarDO.findById", 
				query = "select oc from FacturaPorPagarDO oc where oc.id = :id")})
public class FacturaPorPagarDO  implements java.io.Serializable {
    ...
    public FacturaPorPagarDO(OrdenCompraDO ordenCompra, OrdenCompraMaquiladoDO ordenCompraMaquilado, String folio, Date fecha, Date fechaPago) {
